...
namespace ProgettoRistorazione
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IService<Allergene>, AllergeneService>();
            services.AddScoped<IService<Ingrediente>, IngredienteService>();
            services.AddScoped<IRelationService<Procedimento>, ProcedimentoService>();
            services.AddScoped<IRelationService<Preavviso>, PreavvisoService>();
